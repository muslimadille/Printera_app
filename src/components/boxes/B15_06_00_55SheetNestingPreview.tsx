// B15_06_00_55 — Sheet Nesting Preview
...
import type { B15_06_00_55Params } from '@/lib/b15_06_00_55/types';
import { usableSheet } from '@/lib/b15_06_00_55/types';
import { buildB15_06_00_55Geometry } from '@/lib/b15_06_00_55/geometry';
import type { Segment } from '@/lib/b15_06_00_55/geometry';
...
const B15_06_00_55SheetNestingPreview = ({ params, nesting, result }: Props) => {
  const geo = useMemo(() => buildB15_06_00_55Geometry(params), [params]);
...
export default B15_06_00_55SheetNestingPreview;
