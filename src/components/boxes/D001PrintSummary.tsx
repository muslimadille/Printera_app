...
interface D001PrintSummaryProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  params: D001Params;
  nesting: D001NestingParams;
  nestingResult: D001NestingResult;
  dimUnit: 'mm' | 'cm' | 'in';
...
export default D001PrintSummary;
