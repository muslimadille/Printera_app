...
export default D001SheetNestingPreview;n>
          <span><span className="inline-block w-2.5 h-2.5 rounded-sm align-middle mr-1" style={{ background: CREASE_COLOR }} /> طي CREASE</span>
        </div>
      </div>
    </div>
  );
