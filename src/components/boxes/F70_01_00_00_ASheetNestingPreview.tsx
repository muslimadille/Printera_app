// F70_01_00_00_A — Sheet Nesting Preview
// Strictly standardized to match T0002SheetNestingPreview.tsx gold standard.
// Visualizes the sheet, margins, gripper, and arrayed templates with manual edit mode and stats.

import { useMemo, useState } from 'react';
import { Button } from '@/components/ui/button';
import EditableSheetLayout from '@/components/EditableSheetLayout';
import { Edit3 } from 'lucide-react';
import type { F70_01_00_00_AParams } from '@/lib/f70_01_00_00_a/types';
import { usableSheet } from '@/lib/f70_01_00_00_a/types';
import { buildF70_01_00_00_AGeometry } from '@/lib/f70_01_00_00_a/geometry';
import type { Segment } from '@/lib/f70_01_00_00_a/geometry';
...
interface Props {
  ...
  result: F70_01_00_00_ANestingResult;
}

const F70_01_00_00_ASheetNestingPreview = ({ params, nesting, result }: Props) => {
  const geo = useMemo(() => buildF70_01_00_00_AGeometry(params), [params]);
  ...
  const perRowCols =
    grid.perRowCols && grid.perRowCols.length === grid.rows
      ? grid.perRowCols
...
export default F70_01_00_00_ASheetNestingPreview;
