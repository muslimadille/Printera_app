...
const T00012SheetNestingPreview = ({ params, nesting, result }: Props) => {
  const geo = useMemo(() => buildT00012Geometry(params), [params]);
...
export default T00012SheetNestingPreview;
