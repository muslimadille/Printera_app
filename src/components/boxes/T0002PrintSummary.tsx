...
interface T0002PrintSummaryProps {
  open: boolean;
...
const T0002PrintSummary = ({
  ...
  const pdfFilename = buildQuotePdfFilename({ prefix: 'ملخص-T0002', quoteNumber: 'T0002' });
...
export default T0002PrintSummary;
