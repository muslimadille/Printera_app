// T0003 — Sheet Nesting Preview
// Visualizes the sheet, margins, gripper, and the arrayed templates

import { useMemo } from 'react';
import type { T0003Params } from '@/lib/t0003/types';
import { usableSheet } from '@/lib/t0003/types';
import { buildT0003Geometry } from '@/lib/t0003/geometry';
import type { Segment } from '@/lib/t0003/geometry';
import type { T0003NestingParams, T0003NestingResult } from '@/lib/t0003/nesting';
...
const T0003SheetNestingPreview = ({ params, nesting, result }: Props) => {
  const geo = useMemo(() => buildT0003Geometry(params), [params]);
...
export default T0003SheetNestingPreview;
