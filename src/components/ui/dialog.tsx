  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-h-[min(85vh,920px)] overflow-y-auto overscroll-contain sm:rounded-lg",
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
        "data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%]",
        "data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]",
        // Mobile: widen toward edges + keep scrollable (still centered)
        "max-sm:w-[calc(100%-1rem)] max-sm:max-w-none max-sm:rounded-xl max-sm:p-4",
        className,
      )}
      {...props}
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute end-3 top-3 rounded-sm opacity-70 ring-offset-background transition-opacity",
