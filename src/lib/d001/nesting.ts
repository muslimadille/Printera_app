// D001 Phase 3 — Smart Auto Nesting (silhouette + row-brick) with manual override.
// ----------------------------------------------------------------------------
...
export interface D001NestingResult {
...
// Public API
// ----------------------------------------------------------------------------
export function computeD001Nesting(
  params: D001Params,
