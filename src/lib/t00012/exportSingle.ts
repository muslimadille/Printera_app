...
// T00012 — Export Single Template SVG
...
import type { T00012Geometry, Segment } from "./geometry";
...
export function downloadT00012SingleTemplate(geo: T00012Geometry, filename = "T00012-single-template.svg") {
...
export async function downloadT00012SingleTemplatePdf(
  svgMarkup: string,
  filename = "T00012-single-template.pdf",
) {
