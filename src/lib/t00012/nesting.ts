// T00012 Phase 3 — Smart Auto Nesting (silhouette + row-brick) with manual override.
// ----------------------------------------------------------------------------
...
export interface T00012NestingResult {
...
// Public API
// ----------------------------------------------------------------------------
export function computeT00012Nesting(
  params: T00012Params,
