// T0002 — Nesting Engine (Grid and rotation calculations)
// ----------------------------------------------------------------------------
...
export function computeT0002Nesting(p: T0002Params, nesting: T0002NestingParams): T0002NestingResult {
  const geo = buildT0002Geometry(p);
