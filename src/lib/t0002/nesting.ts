// T0002 Phase 3 — Smart Auto Nesting (silhouette + row-brick) with manual override.
// ----------------------------------------------------------------------------
...
export interface T0002NestingResult {
...
// Public API
// ----------------------------------------------------------------------------
export function computeT0002Nesting(
  params: T0002Params,
  nesting: T0002NestingParams,
): T0002NestingResult {
  const geo = buildT0002Geometry(params);
