...
// T0003 — Export Single Template SVG
...
import type { T0003Geometry, Segment } from "./geometry";
...
export function buildT0003SingleTemplateSvg(geo: T0003Geometry): string {
...
export function downloadT0003SingleTemplate(geo: T0003Geometry, filename = "T0003-single-template.svg") {
...
export async function downloadT0003SingleTemplatePdf(
  svgMarkup: string,
  filename = "T0003-single-template.pdf",
) {
